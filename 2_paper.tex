...
Samples were drawn using NUTS(diag_e) at Tue Aug  5 14:30:11 2025.
...
Samples were drawn using NUTS(diag_e) at Tue Aug  5 14:30:16 2025.
For each parameter, n_eff is a crude measure of effective sample size,
and Rhat is the potential scale reduction factor on split chains (at 
convergence, Rhat=1).
\end{verbatim}
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, left=2mm, toprule=.15mm, leftrule=.75mm, breakable, colframe=quarto-callout-color-frame, arc=.35mm, rightrule=.15mm, bottomrule=.15mm, colback=white]
