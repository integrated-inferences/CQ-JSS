...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}, enhanced, sharp corners, interior hidden, breakable, frame hidden]}{\end{tcolorbox}}\fi
\makeatother
...
Samples were drawn using NUTS(diag_e) at Tue Aug  5 17:52:24 2025.
...
Samples were drawn using NUTS(diag_e) at Tue Aug  5 17:52:39 2025.
For each parameter, n_eff is a crude measure of effective sample size,
and Rhat is the potential scale reduction factor on split chains (at 
convergence, Rhat=1).
\end{CodeOutput}
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, toprule=.15mm, bottomrule=.15mm, left=2mm, arc=.35mm, leftrule=.75mm, breakable, rightrule=.15mm, colframe=quarto-callout-color-frame, opacityback=0]
