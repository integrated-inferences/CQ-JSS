...
Samples were drawn using NUTS(diag_e) at Tue Jul 22 00:29:34 2025.
...
Samples were drawn using NUTS(diag_e) at Tue Jul 22 00:29:51 2025.
For each parameter, n_eff is a crude measure of effective sample size,
and Rhat is the potential scale reduction factor on split chains (at 
convergence, Rhat=1).
\end{CodeOutput}
...
\textbf{?@fig-batch} shows the default plot associated with this query.
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-color-frame, breakable, rightrule=.15mm, bottomrule=.15mm, opacityback=0, toprule=.15mm, arc=.35mm, colback=white, left=2mm, leftrule=.75mm]
