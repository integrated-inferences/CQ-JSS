...
TILL: INTRODUCE IDEA THAT SETTING PRIORS IS JUST ABOUT CHANGING COLUMNS IN parameters_df
...
TILL: ADD EXAMPLE SAME THING WITH EXISTING ARGUMENTS

TILL: alter_at and its risks
...
TILL: point to
<!--# should we show syntax for additionally parallelizing across model >> i.e. nested parallelization? -->
...
requirements:
 ...
 >> we should really add a contributing / code of conduct doc (outlining handling of contributions via PRs + issuing) to github on the off chance that people want contribute 
