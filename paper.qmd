...
Again we make use of the causal structure to simplify. As an example, for the lipids model, the the full joint distribution of nodal types can be simplified as in @eq-join.
