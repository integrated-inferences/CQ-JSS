...
When a model is defined, a set of objects is generated. These are the key quantities that are used for all inference. 

@LM:

1 MAKE A TABLE WITH Core ELEMENTS OF MODEL, and column saying briefly what they are
* Statement
* Parents data frame
