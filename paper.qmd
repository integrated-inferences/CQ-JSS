...
The model includes additional elements, `nodal_types,` `parameters_df,` and `causal_types,` which we explain later.
...
3 After updating the model contains further objects:
small table:
* elemts after updating: stan_obje
...
Version: current 0.1.1 >> by time of publications 1.0.0 >> stable on CRAN, development from GitHub
...
requirements:
        - R Version: R(>= 3.4.0)
        - Packages: >> part of CausalQueries install 
              - Rcpp 
              - RcppEigen 
              - RcppArmadillo 
              - BH
              ...
              - StanHeaders 
              - rstan
         - Compilers: C++ compiler like g++ or clang++ 
         
         
 CausalQueries is being actively developed, issues can be flagged at https://github.com/integrated-inferences/CausalQueries/issues
