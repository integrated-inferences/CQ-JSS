...
To see exactly how the parameters map to causal types we can look at the parameter matrix for the model by calling `get_parameter_matrix(confounded)`.
...
While highly targeted prior setting is convenient and flexible, they should be used with caution. Setting priors on specific parameters in complex models, especially models involving confounding, may strongly affect inferences.
