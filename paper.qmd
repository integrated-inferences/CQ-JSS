...
: Core Elements of a Causal Model. {tbl-colwidths="\[30,70\]"} {#tbl-additional}
...
: Nodal Types in $X \rightarrow Y$ Model. {tbl-colwidths="\[25,25,25,25\]"} {#tbl-joint}
...
Table @tbl-batch-query shows output from a single call to `query_model`.
