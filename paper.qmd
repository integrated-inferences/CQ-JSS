...
When a model is defined, a set of objects is generated. These are the key quantities that are used for all inferential tasks. @tbl-core summarizes the core components of a model, providing a brief explanation for each one.
