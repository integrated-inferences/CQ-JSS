...
The approach used by the `CausalQueries` package to updating parameter values given observed data uses Stan [@carpenter2017stan] and involves the following elements:
...
-   An ambiguity matrix (`A`) that tells Stan how causal types map into data types,
