...
\end{eqnarray} {#eq-join}

We see there are four sets of these parameters. 



The final column shows a sample set of parameter values.

Together  the parameters can describe a full joint probability distribution over types for $Z$, $X$ and $Y$ that is faithful to the graph. 
