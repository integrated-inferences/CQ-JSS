...
the case of \texttt{"Y{[}X=1{]}"}. The variable whose value is observed,
as \(Y\) in the same example, should be placed before the square
brackets. Finally, conditions related to observed or potentially
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, arc=.35mm, left=2mm, bottomrule=.15mm, colback=white, leftrule=.75mm, opacityback=0, rightrule=.15mm, breakable]
