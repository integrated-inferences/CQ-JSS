...
\caption{A plotted model. Curved double headed arrows indicate
...
\includegraphics{paper_files/figure-pdf/unnamed-chunk-32-1.pdf}
...
{\centering \includegraphics{paper_files/figure-pdf/unnamed-chunk-33-1.pdf}
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, breakable, arc=.35mm, left=2mm, rightrule=.15mm, opacityback=0, toprule=.15mm, leftrule=.75mm, colback=white]
