...
Table \textbf{?@tbl-software} provides an overview of relevant software
...
\caption{Related software.\{\#tbl-software\}}\tabularnewline
\toprule\noalign{}
...
is more restrictive than \texttt{CausalQueries} in the the DAGs and
...
posterios over those queries whether or not the queries are identified.
Thus in principle if researchers are interest in learning about a
...
quantities or population quantities and \texttt{CausalQueries} is not
well suited for estimating sample quantities.
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, left=2mm, opacityback=0, breakable, bottomrule=.15mm, colback=white, arc=.35mm, rightrule=.15mm, toprule=.15mm]
