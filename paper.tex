...
query & given & mean & sd & cred.low & cred.high\\
\midrule
Y[X=1] - Y[X=0] & X==1 \& Y==1 \& Z==1 & 0.95 & 0.04 & 0.86 & 1\\
\bottomrule
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, colframe=quarto-callout-color-frame, rightrule=.15mm, left=2mm, breakable, bottomrule=.15mm, toprule=.15mm, arc=.35mm, opacityback=0, leftrule=.75mm]
