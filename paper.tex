...
#> 
#> Samples were drawn using NUTS(diag_e) at Thu Feb 27 11:59:19 2025.
...
#> 
#> Samples were drawn using NUTS(diag_e) at Thu Feb 27 11:59:34 2025.
#> For each parameter, n_eff is a crude measure of effective sample size,
#> and Rhat is the potential scale reduction factor on split chains (at 
#> convergence, Rhat=1).
\end{verbatim}
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, toprule=.15mm, breakable, arc=.35mm, colback=white, leftrule=.75mm, colframe=quarto-callout-color-frame, left=2mm, rightrule=.15mm, opacityback=0]
...
\bottomrule\noalign{}
\endlastfoot
\(X1 \rightarrow Y\) & 6 & 7.08 \\
\(X1 \rightarrow Y; X2 \rightarrow Y\) & 20 & 9.82 \\
\(X1\rightarrow Y;X2\rightarrow Y;X3\rightarrow Y\) & 262 & 99.82 \\
...
\bottomrule\noalign{}
\endlastfoot
\(X1 \rightarrow Y\) & 10 & 9.03 \\
\(X1 \rightarrow Y\) & 100 & 9.07 \\
\(X1 \rightarrow Y\) & 1000 & 11.30 \\
\(X1 \rightarrow Y\) & 10000 & 17.41 \\
