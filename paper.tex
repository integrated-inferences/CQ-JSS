...
#> 
#> Samples were drawn using NUTS(diag_e) at Wed Feb 12 16:35:14 2025.
...
#> 
#> Samples were drawn using NUTS(diag_e) at Wed Feb 12 16:35:28 2025.
#> For each parameter, n_eff is a crude measure of effective sample size,
#> and Rhat is the potential scale reduction factor on split chains (at 
#> convergence, Rhat=1).
\end{verbatim}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, toprule=.15mm, leftrule=.75mm, colframe=quarto-callout-color-frame, opacityback=0, rightrule=.15mm, arc=.35mm, bottomrule=.15mm, left=2mm, colback=white]
...
\bottomrule\noalign{}
\endlastfoot
\(X1 \rightarrow Y\) & 6 & 6.33 \\
\(X1 \rightarrow Y; X2 \rightarrow Y\) & 20 & 9.05 \\
\(X1\rightarrow Y;X2\rightarrow Y;X3\rightarrow Y\) & 262 & 100.49 \\
...
\bottomrule\noalign{}
\endlastfoot
\(X1 \rightarrow Y\) & 10 & 9.02 \\
\(X1 \rightarrow Y\) & 100 & 9.51 \\
\(X1 \rightarrow Y\) & 1000 & 11.25 \\
\(X1 \rightarrow Y\) & 10000 & 17.54 \\
