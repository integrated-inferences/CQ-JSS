...
#> 
#> Samples were drawn using NUTS(diag_e) at Fri Nov  1 02:15:59 2024.
...
#> 
#> Samples were drawn using NUTS(diag_e) at Fri Nov  1 02:16:05 2024.
#> For each parameter, n_eff is a crude measure of effective sample size,
#> and Rhat is the potential scale reduction factor on split chains (at 
#> convergence, Rhat=1).
#> 
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-color-frame, arc=.35mm, rightrule=.15mm, leftrule=.75mm, bottomrule=.15mm, toprule=.15mm, colback=white, opacityback=0, left=2mm, breakable]
