...
{\centering \includegraphics{paper_files/figure-pdf/unnamed-chunk-24-1.pdf}
...
{\centering \includegraphics{paper_files/figure-pdf/fig-posterior-dist-1.pdf}
...
{\centering \includegraphics{paper_files/figure-pdf/fig-query-dist-1.pdf}
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, leftrule=.75mm, toprule=.15mm, breakable, opacityback=0, bottomrule=.15mm, rightrule=.15mm, left=2mm, colback=white]
