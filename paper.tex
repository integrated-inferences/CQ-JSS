...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.1170}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.8830}}@{}}
\toprule\noalign{}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.2155}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.7845}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Element
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.0992}}
  >{\centering\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2893}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.2893}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1901}}@{}}
\toprule\noalign{}
...
R> 
R> data  <- fabricate(N = 10, X = complete_ra(N), Y = X)
R> 
R> model <- make_model("X -> Y") |>
...
\includegraphics{paper_files/figure-pdf/unnamed-chunk-46-1.pdf}
...
{\centering \includegraphics{paper_files/figure-pdf/unnamed-chunk-47-1.pdf}
...
1 Y[X=1] - Y[X=0] X==1 & Y==1 & Z==1 posteriors      FALSE 0.9541329 0.03575594
  cred.low.2.5% cred.high.97.5%
1     0.8624872       0.9969585
\end{verbatim}
...
\begin{longtable}[]{@{}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.2080}}
  >{\centering\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.6800}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.1040}}@{}}
\toprule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
\begin{tcolorbox}[enhanced jigsaw, breakable, bottomrule=.15mm, arc=.35mm, left=2mm, rightrule=.15mm, toprule=.15mm, colback=white, leftrule=.75mm, opacityback=0]
