...
nodal types for \(Y\) \emph{given} the nodal types for \(X\). This
allows us to faithfully represent the full joint distribution of nodal
types (see \textbf{?@eq-join}).
...
Together the parameters can describe a full joint probability
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colback=white, toprule=.15mm, breakable, rightrule=.15mm, arc=.35mm, leftrule=.75mm, bottomrule=.15mm, left=2mm]
