...
\texttt{CausalQueries} lets uses pose nested ``complex counterfactual''
...
SUch answers can draw directly from the prior distribution of the
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, bottomrule=.15mm, opacityback=0, colback=white, breakable, leftrule=.75mm, left=2mm, toprule=.15mm, arc=.35mm]
