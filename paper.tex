...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, sharp corners, borderline west={3pt}{0pt}{shadecolor}, enhanced, interior hidden, breakable, boxrule=0pt]}{\end{tcolorbox}}\fi
...
\midrule()
\endhead
Y{[}X=1{]} - Y{[}X=0{]} & - & 0.55 & 0.10 & 0.37 & 0.72 \\
...
{\centering \includegraphics{paper_files/figure-pdf/unnamed-chunk-40-1.pdf}
...
\includegraphics{paper_files/figure-pdf/unnamed-chunk-76-1.pdf}
...
{\centering \includegraphics{paper_files/figure-pdf/unnamed-chunk-78-1.pdf}
...
\begin{longtable}[]{@{}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.2241}}
  >{\centering\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.7155}}
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-color-frame, opacityback=0, breakable, leftrule=.75mm, arc=.35mm, colback=white, left=2mm, bottomrule=.15mm, toprule=.15mm, rightrule=.15mm]
