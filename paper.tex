...
Table Table~\ref{tbl-software} provides an overview of relevant software
and discusses key connections, advantages and disadvantages with respect
...
For concreteness: table Table~\ref{tbl-lipidspar} illustrates key values
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.1311}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.4417}}
...
\texttt{posterior\_distribution}} &
\multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.8641} + 2\tabcolsep}@{}}{%
\multirow{2}{*}{Description \textbar{}
==========================================================================================+
The posterior distribution of the updated parameters generated by stan.
\textbar{}}} \\
 \\
\texttt{stan\_objects} &
\multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.8641} + 2\tabcolsep}@{}}{%
A list of additional objects, including, the data used, the
\texttt{stanfit} object and distributions over transformed parameters
(event probabilities and causal types).} \\
\texttt{data} &
\multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.8641} + 2\tabcolsep}@{}}{%
The data used for updating the model, always included in
\texttt{stan\_objects.} \textbar{}} \\
\texttt{type\_distribution} &
\multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.8641} + 2\tabcolsep}@{}}{%
The updated distribution of the nodal types, appended to
\texttt{stan\_objects} by default. \textbar{}} \\
\texttt{w} & A mapping from parameters to event probabilities,
optionally appended to \texttt{stan\_objects.} & \\
\texttt{stan\_fit} &
\multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.8641} + 2\tabcolsep}@{}}{%
The \texttt{stanfit} object generated by stan,optionally appended to
\texttt{stan\_objects.} \textbar{}} \\
\end{longtable}
...
To speed up different operations it is sometimes useful to have the
\(P\) matrix added to the model:
...
result as above by specifying nodal types for which we would like to
adjust the priors:
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, toprule=.15mm, colback=white, opacityback=0, left=2mm, arc=.35mm, bottomrule=.15mm, breakable, rightrule=.15mm]
