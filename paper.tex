...
#> 
#> Samples were drawn using NUTS(diag_e) at Mon Feb 10 15:29:57 2025.
...
#> 
#> Samples were drawn using NUTS(diag_e) at Mon Feb 10 15:30:13 2025.
#> For each parameter, n_eff is a crude measure of effective sample size,
#> and Rhat is the potential scale reduction factor on split chains (at 
#> convergence, Rhat=1).
\end{verbatim}
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacityback=0, bottomrule=.15mm, arc=.35mm, breakable, toprule=.15mm, rightrule=.15mm, colback=white, colframe=quarto-callout-color-frame, leftrule=.75mm]
