...
\end{itemize}
\end{minipage} \\
`DoWhy & \citet{dowhy} & \proglang{Python} &
\begin{minipage}[t]{\linewidth}\raggedright
\begin{itemize}
\tightlist
\item
...
set to be \(0.5\), while the other nodal types of this parameter set
...
#> 
#> Samples were drawn using NUTS(diag_e) at Thu Apr 25 23:54:55 2024.
...
the causal types (see \texttt{grab(model,\ "causal\_types")}) and
...
#> 
#> Samples were drawn using NUTS(diag_e) at Thu Apr 25 23:54:56 2024.
#> For each parameter, n_eff is a crude measure of effective sample size,
#> and Rhat is the potential scale reduction factor on split chains (at 
#> convergence, Rhat=1).
\end{verbatim}
...
#> |:---------------|:------------------|:----------|-----:|-----:|--------:|---------:|
#> |Y[X=1] - Y[X=0] |X==1 & Y==1 & Z==1 |posteriors | 0.954| 0.036|    0.865|     0.997|
\end{verbatim}
...
#> |:---------------|:------------------|:----------|:----------|-----:|-----:|--------:|---------:|
#> |Y[X=1] > Y[X=0] |X==1 & Y==1 & M==1 |posteriors |TRUE       | 0.675|    NA|    0.675|     0.675|
#> |Y[X=1] > Y[X=0] |X==1 & Y==1 & M==1 |posteriors |FALSE      | 0.428| 0.328|    0.003|     0.940|
\end{verbatim}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, toprule=.15mm, left=2mm, rightrule=.15mm, leftrule=.75mm, bottomrule=.15mm, arc=.35mm, colframe=quarto-callout-color-frame, colback=white, opacityback=0]
