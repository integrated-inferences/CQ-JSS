...
is a condition about potentially observed values, it is expressed as in
the paragraph above using the logical operator \texttt{==}. More
precisely, such query can be written as \texttt{"Y{[}X=0{]}\ ==\ 1"}.
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, toprule=.15mm, arc=.35mm, colback=white, opacityback=0, rightrule=.15mm, breakable, bottomrule=.15mm, left=2mm]
