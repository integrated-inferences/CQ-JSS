...
\begin{tcolorbox}[enhanced jigsaw, breakable, colframe=quarto-callout-color-frame, toprule=.15mm, arc=.35mm, bottomrule=.15mm, leftrule=.75mm, colback=white, left=2mm, opacityback=0, rightrule=.15mm]
