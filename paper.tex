...
For concreteness: table \textbf{?@tbl-lipidspar} illustrates key values
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.7583}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0083}}@{}}
...
\multicolumn{2}{>{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.7667} + 2\tabcolsep}@{}}{%
The posterior distribution of the updated parameters generated by
stan.} \\
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, opacityback=0, colback=white, bottomrule=.15mm, breakable, toprule=.15mm, rightrule=.15mm, arc=.35mm, left=2mm]
