...
Later (e.g. \textbf{?@tbl-confound-params-mat}) we will see examples
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, bottomrule=.15mm, leftrule=.75mm, rightrule=.15mm, breakable, opacityback=0, arc=.35mm, toprule=.15mm, left=2mm]
