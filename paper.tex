...
#> 
#> Samples were drawn using NUTS(diag_e) at Fri Apr 19 11:29:33 2024.
...
#> 
#> Samples were drawn using NUTS(diag_e) at Fri Apr 19 11:29:39 2024.
#> For each parameter, n_eff is a crude measure of effective sample size,
#> and Rhat is the potential scale reduction factor on split chains (at 
#> convergence, Rhat=1).
\end{verbatim}
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, opacityback=0, left=2mm, leftrule=.75mm, rightrule=.15mm, breakable, arc=.35mm, bottomrule=.15mm, colback=white]
