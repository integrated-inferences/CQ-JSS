...
Y{[}X=1{]} - Y{[}X=0{]} & X==0 \& Y==0 & 0.63 & 0.15 & 0.37 & 0.89 \\
...
\includegraphics{paper_files/figure-pdf/unnamed-chunk-34-1.pdf}
...
{\centering \includegraphics{paper_files/figure-pdf/unnamed-chunk-35-1.pdf}
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, opacityback=0, left=2mm, colback=white, breakable, toprule=.15mm, bottomrule=.15mm, rightrule=.15mm, leftrule=.75mm]
