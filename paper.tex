...
detail in Section~\ref{sec-confounding}.
...
\(Z\). If we wanted to retain only this nodal type rather than remove it
could do so by stipulating \texttt{keep\ =\ FALSE}.
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, opacityback=0, leftrule=.75mm, colback=white, rightrule=.15mm, arc=.35mm, bottomrule=.15mm, toprule=.15mm, breakable]
