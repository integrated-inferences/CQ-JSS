...
Y[X=1] - Y[X=0] & X==0 \& Y==0 & 0.64 & 0.15 & 0.37 & 0.88\\
...
model reduces to learning about the distribution over the nodal types,
\(\lambda\).
...
#> |model      |query           |  mean|    sd|
#> |:----------|:---------------|-----:|-----:|
#> |uncensored |Y[X=1] - Y[X=0] | 0.590| 0.195|
...
#> X.0         0.50    0.01 0.29   0.03  0.26  0.50  0.75  0.97  2807    1
#> X.1         0.50    0.01 0.29   0.03  0.25  0.50  0.74  0.97  2807    1
#> Y.00        0.24    0.00 0.19   0.01  0.09  0.19  0.35  0.71  1871    1
#> Y.10        0.25    0.00 0.20   0.01  0.09  0.20  0.37  0.73  4088    1
#> Y.01        0.25    0.00 0.20   0.01  0.09  0.21  0.37  0.72  4506    1
#> Y.11        0.26    0.00 0.20   0.01  0.09  0.21  0.39  0.71  4291    1
#> lp__       -7.68    0.05 1.81 -12.39 -8.55 -7.26 -6.34 -5.42  1286    1
#> 
#> Samples were drawn using NUTS(diag_e) at Mon Nov  4 09:10:21 2024.
...
#> 
#>             mean se_mean   sd   2.5%   25%   50%   75% 97.5% n_eff Rhat
#> lambdas[1]  0.50    0.01 0.29   0.02  0.26  0.51  0.75  0.98  3019    1
#> lambdas[2]  0.50    0.01 0.29   0.02  0.25  0.49  0.74  0.98  3019    1
#> lambdas[3]  0.26    0.00 0.20   0.01  0.10  0.21  0.38  0.71  1985    1
#> lambdas[4]  0.24    0.00 0.19   0.01  0.09  0.20  0.36  0.70  3835    1
#> lambdas[5]  0.24    0.00 0.19   0.01  0.09  0.20  0.36  0.70  4602    1
#> lambdas[6]  0.25    0.00 0.20   0.01  0.09  0.21  0.37  0.72  4075    1
#> types[1]    0.13    0.00 0.14   0.00  0.03  0.08  0.19  0.51  2290    1
#> types[2]    0.13    0.00 0.13   0.00  0.03  0.08  0.18  0.48  2289    1
#> types[3]    0.12    0.00 0.13   0.00  0.03  0.08  0.18  0.49  3489    1
#> types[4]    0.12    0.00 0.13   0.00  0.02  0.08  0.17  0.48  3275    1
#> types[5]    0.12    0.00 0.13   0.00  0.02  0.08  0.18  0.48  3630    1
#> types[6]    0.12    0.00 0.13   0.00  0.03  0.08  0.17  0.48  3219    1
#> types[7]    0.13    0.00 0.13   0.00  0.03  0.08  0.18  0.48  3256    1
#> types[8]    0.13    0.00 0.13   0.00  0.03  0.08  0.19  0.51  3449    1
#> lp__       -7.58    0.04 1.69 -11.83 -8.43 -7.20 -6.33 -5.43  1428    1
#> 
#> Samples were drawn using NUTS(diag_e) at Mon Nov  4 09:10:22 2024.
#> For each parameter, n_eff is a crude measure of effective sample size,
#> and Rhat is the potential scale reduction factor on split chains (at 
#> convergence, Rhat=1).
\end{verbatim}
...
models in hand, queries involving arbitrary \texttt{do} operations can
be posed using an intuitive syntax.
...
which can currently only be calculated by combining multiple simple
causal queries. Finally we see scope for more integrated functionality
for model validation, including assessments of sensitivity of
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, left=2mm, colback=white, toprule=.15mm, arc=.35mm, colframe=quarto-callout-color-frame, bottomrule=.15mm, rightrule=.15mm, breakable, leftrule=.75mm]
